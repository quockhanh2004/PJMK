...
//    }
//
//    private void fetchData(int VNumber, final DataCallback callback) {
...
//        String apiUrl = BASE_URL + "update/" + TOKEN + "/V" + VNumber + "?value=" + data;
//
//        StringRequest stringRequest = new StringRequest(Request.Method.GET, apiUrl,
//                System.out::println,
//                System.out::println);
...
//    }
//
//    public void startFetchingData(int VNumber, final DataCallback callback, long interval) {
